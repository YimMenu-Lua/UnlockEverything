...
wasabi_words:add_button("ShinyWasabi", function() -- Original script by ShinyWasabi
    script.run_in_fiber(function (script)
        ...
        unlock_packed_bools(3616, 3616) -- Please Stop Me Hockey (Mask)
        unlock_packed_bools(3750, 3750) -- Stocking (Mask)
        ...
        unlock_packed_bools(9443, 9443) -- Unicorn (Mask)
        ...
        unlock_packed_bools(32319, 32323) -- Stanier LE Cruiser (Trade Price)
        ...
        unlock_packed_bools(42152, 42190) -- The LSDS (Outfit), The McTony Security (Outfit), Wooden Dragon Mask, Contrast Dragon Mask, Regal Dragon Mask, Midnight Dragon Mask, Pink Heart Shades, Red Heart Shades, Orange Heart Shades, Yellow Heart Shades, Green Heart Shades, Blue Heart Shades, Purple Heart Shades, Black Heart Shades, Fireworks Bucket Hat, Stars and Stripes Bucket Hat, Lady Liberty Bucket Hat, Green Festive Tree Hat, Red Festive Tree Hat, Brown Festive Reindeer Hat, White Festive Reindeer Hat, Bronze New Year's Hat, Gold New Year's Hat, Silver New Year's Hat, Sprunk x eCola Bodysuit, Rockstar Racing Suit, Rockstar Helmet, Coil Earth Day Tee, IR Earth Day Tee, White High Brass Tee, Black High Brass Tee, Black Lunar New Year Tee, Bigness Carnival Sports Tee, Green 420 Dress, Red Lunar New Year Dress, Carnival Sun Dress, Carnival Bandana, Bigness Carnival Bucket Hat, Black 420 Forwards Cap
        unlock_packed_bools(42217, 42217) -- Cluckin' Bell Forwards Cap
        unlock_packed_bools(42233, 42234) -- Boxville (LSDS), Benson (Cluckin' Bell)
        unlock_packed_bools(42239, 42242) -- Cavalcade XL, Impaler SZ, Gauntlet Interceptor, Dorado
        unlock_packed_bools(42244, 42247) -- Baller ST-D, Terminus, Boxville (LSDS), Benson (Cluckin' Bell)
        ...
        stats.set_packed_stat_int(7315, 6) -- Stone Hatchet
        stats.set_packed_stat_int(18981, 4) -- Double-Action Revolver
        ...
        stats.set_packed_stat_int(22050, 5) -- Oppressor Mk II (Trade Price)
        ...
        stats.set_packed_stat_int(22063, 20) -- Go Go Monkey Blista
        stats.set_packed_stat_int(41237, 10) -- Taxi Livery for Eudora
        ...
        stats.set_int('MPPLY_GANGOPS_LOYALTY2', 536870911)
        stats.set_int('MPPLY_GANGOPS_LOYALTY3', 536870911)
        stats.set_int('MPPLY_GANGOPS_CRIMMASMD2', 536870911)
        stats.set_int('MPPLY_GANGOPS_CRIMMASMD3', 536870911)
        stats.set_int('MPPLY_GANGOPS_SUPPORT', 536870911)
        stats.set_int('MPPLY_GANGOPS_ALLINORDER', 536870911)
        stats.set_int('MPPLY_GANGOPS_LOYALTY', 536870911)
        stats.set_int('MPPLY_GANGOPS_CRIMMASMD', 536870911)
